...
df_mccance = pd.read_parquet(new_food_path)
...
print("\n[3/4] Copying swissfcdb nutrient buckets into main FDC buckets...")
...
print("\n==================================================")
print("ALL DONE! Asnut is fully integrated.")
