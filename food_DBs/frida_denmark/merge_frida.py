...
new_food_path = "frida_food_injection.parquet"
backup_path = "/data/bac2food/food_backup_mccance.parquet"

src_buckets = "frida_food_nutrient_bucketed"
...
print("\n[3/4] Copying Frida nutrient buckets into main FDC buckets...")
...
print("\n==================================================")
print("ALL DONE! Frida is fully integrated.")
