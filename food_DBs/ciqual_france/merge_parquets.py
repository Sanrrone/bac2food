...
ciqual_food_path = "ciqual_food_injection.parquet"
backup_path = "/data/bac2food/food_backup_ciqual.parquet"

src_buckets = "ciqual_food_nutrient_bucketed"
...
df_ciqual = pd.read_parquet(ciqual_food_path)
