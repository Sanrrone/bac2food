...
cnf_food_path = "cnf_food_injection.parquet"
backup_path = "/data/bac2food/archive/food_backup_cnf.parquet"

src_buckets = "cnf_food_nutrient_bucketed"
...
print("\n[3/4] Copying CNF nutrient buckets into main FDC buckets...")
